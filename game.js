...
var steps = []; // записываем каждый ход
...
let showStep = n => {
	if(steps[n-1]) {
		console.log(`на ${n}-м ходу вы ввели ${steps[n-1]}`);
	} else {
		console.log(`на ${n}-м ходу вы ничего не ввели `);
	}
}
showStep(+prompt("какой ход хотите посмотреть",'1'));